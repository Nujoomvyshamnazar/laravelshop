      ...
      <div class="tm-heroslider-area bg-grey">
            <div class="tm-heroslider-slider">
                ...
                <!-- Heroslider Item -->
                <div class="tm-heroslider" data-bgimage="{{ asset('assets/images/heoslider-image-1.jpg') }}">
                    <div class="container">
                ...
                <!-- Heroslider Item -->
                <div class="tm-heroslider" data-bgimage="{{ asset('assets/images/heoslider-image-2.jpg') }}">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7 col-md-8 col-12">
                                <div class="tm-heroslider-contentwrapper">
