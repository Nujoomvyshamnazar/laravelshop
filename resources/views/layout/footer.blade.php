        ...
        <div class="row align-items-center">
            <div class="col-md-7">
                <p class="tm-footer-copyright">©
                    2023. Designed by <a href="£">V A Nujoom</a></p>
            </div>
            <div class="col-md-5">
                <div class="tm-footer-payment">
                    <img src="{{ asset('assets/images/payment-methods.png') }}" alt="payment methods">
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="tm-prodetails-images">
                                <div class="tm-prodetails-largeimages">
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-1.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-2.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-3.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-4.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-6.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-largeimage">
                                        <img src="{{ asset('assets/images/products/product-image-6.jpg') }}"
                                ...
                                <div class="tm-prodetails-thumbnails">
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-1-thumb.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-2-thumb.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-3-thumb.jp') }}g"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-4-thumb.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-5-thumb.jpg') }}"
                                            alt="product image">
                                    </div>
                                    <div class="tm-prodetails-thumbnail">
                                        <img src="{{ asset('assets/images/products/product-image-6-thumb.jpg') }}"
                                            alt="product image">
                                    </div>
                                </div>
                            </div>
